...
$data = pdo_query($sql);
$sql_3 = "SELECT COUNT(ma_slide) FROM slider";
        ...
        <div class="panel panel-container">
            <div class="col-lg-3 col-sm col-md-3 mb-1">
                <div class="list-group  shadow-sm">
                    ...
                    <a href="#" class="list-group-item primary text-primary fw-semi-bold" data-target="#addModal"
                        data-toggle="modal">Thêm slide</a>
                    <a href="#" class="list-group-item "><span class="text-danger ">Số image : <?=$data_3?> </span> </a>
                </div>
            ...
            <div class="col-8 ">
                <div class="table-responsive rounded px-2 table-bordered">
                    <form action="\du_an_1\admin-template-master\4.slider\handle.php" method="post">
                        ...
                        <table class="table table-striped table-hover bg-light  shadow-sm table-info  ">
                            ...
                            <tr class="text-left">
                                <td width="15%"><input type="checkbox" id="checkItem" name="check[]"
                                        value="<?php echo $slide['ma_slide']; ?>">

                                </td><td><?=$slide['ma_slide']?></td>    
                                <td><?=$slide['ten_slide']?></td>
                                <td><img src="<?=$slide['url_slide']?>" alt="" width="50px" height="50px"></td>
                                <td width="10%">
                                    <a href="#" data-href="\du_an_1\admin-template-master\4.slider\handle.php?id=<?=$slide['ma_slide']?>" data-target="#confirm-delete" data-toggle="modal"
                ...
                <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <form action="\du_an_1\admin-template-master\4.slider\handle.php" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label>Mã slide</label>
                                        <input class="form-control" placeholder="Autonumber" readonly name="ma_slide">
                                    </div>
                                    <div class="form-group">
                                        <label>Tên slide</label>
                                        <input type="text" name="ten_slide">
                                    </div>
                                    <div class="form-group">
                                        <label>Ảnh slide</label>
                                        <input type="file" name="url_slide">
                                    </div>
                                </div>
